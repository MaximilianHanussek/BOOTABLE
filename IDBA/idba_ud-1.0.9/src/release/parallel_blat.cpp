...
int main(int argc, char *argv[])
{
    ...
    options.push_back(" -tileSize=18 -minMatch=40 -maxGap=0 -maxIntron=1000 -minIdentity=95 -minScore=100 ");
    //options.push_back(" -tileSize=18 -minMatch=20 -maxGap=0 -maxIntron=1000 -minIdentity=95 -minScore=100 ");
    options.push_back(" -tileSize=18 -minMatch=15 -maxGap=0 -maxIntron=1000 -minIdentity=95 -minScore=100 ");
    //options.push_back(" -tileSize=18 -minMatch=5 -maxGap=1 -maxIntron=1000 -minIdentity=95 -minScore=100 ");
    options.push_back(" -tileSize=18 -minMatch=4 ");
