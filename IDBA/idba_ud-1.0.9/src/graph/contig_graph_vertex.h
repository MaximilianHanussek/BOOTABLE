...
//    uint32_t &in_kmer_count() { return in_kmer_count_; }
//    const uint32_t &in_kmer_count() const { return in_kmer_count_; }
//
//    uint32_t &out_kmer_count() { return out_kmer_count_; }
//    const uint32_t &out_kmer_count() const { return out_kmer_count_; }
...
//    uint32_t in_kmer_count_;
//    uint32_t out_kmer_count_;
};
